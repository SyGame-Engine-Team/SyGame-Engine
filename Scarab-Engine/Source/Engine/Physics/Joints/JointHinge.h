/////////////////////////////////////////////////////////////////////////////////
// File : Engine/Physics/Joints/JointHinge.h
/////////////////////////////////////////////////////////////////////////////////
// Version : 1.0a
...
/////////////////////////////////////////////////////////////////////////////////
// Header prelude
#ifndef SCARAB_ENGINE_PHYSICS_JOINTS_JOINTHINGE_H
#define SCARAB_ENGINE_PHYSICS_JOINTS_JOINTHINGE_H
...
/////////////////////////////////////////////////////////////////////////////////
// The JointHinge class
class JointHinge : public JointConstraint
{
public:
    JointHinge( BodyNode * pBodyA, BodyNode * pBodyB, const Transform3 & vJointFrame );
    JointHinge( BodyNode * pBodyA, BodyNode * pBodyB, const Transform3 & vFrameInA, const Transform3 & vFrameInB );
    virtual ~JointHinge();
    ...
    inline Scalar GetRotation( Vector3 * outAxis ) const;
...
protected:
    ...
    Vector3 m_vHingeAxis;
    Scalar m_fHingeAngle;

    // Constraint rows
    JointLimitMotorSpring m_hAngularLMS;
};

/////////////////////////////////////////////////////////////////////////////////
// Backward Includes (Inlines & Templates)
#include "JointHinge.inl"

/////////////////////////////////////////////////////////////////////////////////
// Header end
#endif // SCARAB_ENGINE_PHYSICS_JOINTS_JOINTHINGE_H
