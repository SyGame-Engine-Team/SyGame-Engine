/////////////////////////////////////////////////////////////////////////////////
// File : Engine/Rendering/Effects/EffectLibrary/Lighting/EffectMaterialTexture.cpp
/////////////////////////////////////////////////////////////////////////////////
// Version : 1.0a
...
/////////////////////////////////////////////////////////////////////////////////
// Includes
#include "EffectMaterialTexture.h"

#include "../../../RenderingManager.h"

/////////////////////////////////////////////////////////////////////////////////
// EffectMaterialTexture implementation
const AChar * EffectMaterialTexture::sm_strHLSLCode = (
    // Constants
    "matrix matWVP;"
...
const UInt EffectMaterialTexture::sm_iHLSLCodeLength = StringFn->LengthA( sm_strHLSLCode );

EffectMaterialTexture::EffectMaterialTexture():
    Effect(),
    ...
    m_hPass(), m_hTechnique()
{
    ...
    hCompilationData.strName = "EffectLib.MaterialTexture.VS";
    ...
    hCompilationData.strName = "EffectLib.MaterialTexture.PS";
...
EffectMaterialTextureInstance * EffectMaterialTexture::CreateInstance( Material * pMaterial, GPUTexture2D * pTexture ) const
{
    Assert( pTexture->IsBound() );
    Assert( pTexture->GetBinds() & GPURESOURCE_BIND_SHADER_INPUT );

    RenderingFn->SelectMemory( TEXT("Effects") );
    EffectMaterialTextureInstance * pInstance = New EffectMaterialTextureInstance( this, pMaterial, pTexture );
...
EffectMaterialTextureInstance::EffectMaterialTextureInstance( const EffectMaterialTexture * pEffectMaterialTexture, Material * pMaterial, GPUTexture2D * pTexture ):
    EffectInstance( pEffectMaterialTexture, 0 ), m_hParameters(),
    m_hVSParameters( pEffectMaterialTexture->GetVertexShader(0,0) ),
    m_hPSParameters( pEffectMaterialTexture->GetPixelShader(0,0) ),
    m_hPSSampler()
{
...
EffectMaterialTextureInstance::~EffectMaterialTextureInstance()
{
...
Void EffectMaterialTextureInstance::UpdateConstants( UInt iPass, const Transform3 * pWorldTransform, const Camera * pCamera, GPUDeferredContext * pContext ) const
{
