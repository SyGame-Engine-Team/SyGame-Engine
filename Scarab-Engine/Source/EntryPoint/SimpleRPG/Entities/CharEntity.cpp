/////////////////////////////////////////////////////////////////////////////////
// File : EntryPoint/SimpleRPG/Entities/CharEntity.cpp
/////////////////////////////////////////////////////////////////////////////////
// Version : 1.0a
...
CharEntity::CharEntity( BaseCharacter * pCharacter, const Vertex3 & vPosition ):
    SimpleEntity( pCharacter->GetName() ),
    m_vPathTarget()
{
    ...
    SetupGraphics( TEXT("Player"), EFFECTID_LIGHT_MATERIAL, arrParameters );
...
SelectionMarkerEntity::SelectionMarkerEntity( BaseCharacter * pCharacter ):
    SimpleEntity( _Wrapper_GetName(pCharacter->GetName()) )
{
    m_pCharacter = pCharacter;
    ...
    SetupGraphics( TEXT("SelectionMarker"), EFFECTID_LIGHT_MATERIAL, arrParameters );
